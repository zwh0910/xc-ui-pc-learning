...
let xcApiUrl = sysConfig.xcApiUrlPre
module.exports = {
  dev: {
    ...
    proxyTable: {
      ...
      '/api/video': {
        target: 'http://video.xuecheng.com',
        pathRewrite: {
          '^/api': ''
        }
      }
    ...
    port: 13000, // can be overwritten by process.env.PORT, if port is in use, a free one will be determined
